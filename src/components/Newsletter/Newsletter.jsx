...
const Newsletter = () => {
  return (
    <div className='w-screen h-full justify-center   bg-[#EFF2F4] flex  flex-col  p-2 '>
     ...
     <p className='flex justify-center text-red-500 m-2 text-bold'>Get timely Updates from your favorite Products</p>
      <div className='flex justify-center mb-2'>
        <input className='w-2/4 rounded-l-sm p-1 bg-yellow-400 text-blue-700' placeholder='Your Email here:' type="email" ></input>
