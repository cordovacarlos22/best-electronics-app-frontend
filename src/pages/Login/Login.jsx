...
const Login = () => {
  ...
  return (
    ...
    >
      <nav className='bg-blue-700 w-screen h-16  flex justify-between items-center p-2'>
     ...
     <div className='flex justify-center h-full w-full'>
        ...
        >
          ...
          <p className='p-2 flex items-center justify-center w-full'>By continuing you agree to our Terms and Conditions, our Privacy Policy, and the Best Deals <Link as={Link} to="/terms"><span className='text-blue-600 hover:underline'>Terms.</span></Link></p>
          <hr className='w-full'></hr>
          <h2>Don't have an account? <Link as={Link} to="/UserRegister"><span className='text-blue-600 hover:underline'>Create an account</span></Link></h2>
        </div>
        
     </div>
      <div className='w-screen h-[200px] bg-blue-600'>
        <p>
